  <aside class="main-sidebar sidebar-dark-navy bg-blue elevation-4">
    <div class="dropdown">
   	<a href="javascript:void(0)" class="brand-link bg-blue" data-toggle="dropdown" aria-expanded="true">
        ...
        <span class="brand-text font-weight-dark  text-gradient-primary"><i>MeloManiac</i></span>
